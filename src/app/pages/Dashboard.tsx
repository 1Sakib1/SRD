...
const ReportCard = ({ report, getStatusColor, onDelete }: { report: any; getStatusColor: any; onDelete: (id: string) => void }) => {
              ...
              <div className="text-center py-12">
                ...
                >
                  ...
                  {userReports.map((report) => (
                    <ReportCard key={report.id} report={report} getStatusColor={getStatusColor} onDelete={handleDeleteReport} />
                  ))}
                </div>
              )}
          </div>
